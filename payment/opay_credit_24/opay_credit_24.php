<?php
	...
	class plgHikashoppaymentopay_credit_24 extends hikashopPaymentPlugin {
		public $accepted_currencies = array('TWD');
		public $multiple = true;
		public $name = 'opay_credit_24';
		...
		function onAfterOrderConfirm(&$order,&$methods,$method_id) {
            ...
            try {
                ...
                $AIO->Send['TradeDesc'] = 'opay_module_hikashop_1_1_0118';
        ...
        private function invokeExt($ext_dir) {
            ...
            $ext_res = include_once($ext_dir . 'opay_cart_ext.php');
