<?php
    ...
    */
    ...
    abstract class ServiceURL {
        const PROD_CO = 'https://payment.opay.tw/Cashier/AioCheckOut';
        const STAGE_CO = 'https://payment-stage.opay.tw/Cashier/AioCheckOut';
        const PROD_QO = 'https://payment.opay.tw/Cashier/QueryTradeInfo';
        const STAGE_QO = 'http://payment-stage.opay.tw/Cashier/QueryTradeInfo';
    }
    ...
    abstract class LogMsg {
        const RESP_DES = 'Recive OPay response.';
        const RESP_RES = 'Processed result: %s';
    }
    
    abstract class ErrorMsg {
        const EXT_MISS = 'OPay extension missed.';
        const C_FD_EMPTY = 'OPay checkout feedback is empty.';
        const Q_FD_EMPTY = 'OPay query feedback is empty.';
